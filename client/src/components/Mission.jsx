function Mission() {
	return (
		<section className="h-full w-full rounded-lg bg-clip-padding backdrop-filter backdrop-blur-lg px-8 pt-6 pb-8 mb-4">
			<div className="grid text-sm sm:text-2xl">
				<p>
					Welcome to{' '}
				...
				<p>
					...
					, we understand that the financial landscape can be
					overwhelming, especially for those who are just beginning
					their journey into the world of investing. That's why we've
					created a space that speaks directly to the unique needs and
