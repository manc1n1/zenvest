...
const Dashboard = () => {
	...
	return (
		<section className="w-full max-w-xl p-5 sm:p-0 mx-auto text-white text-opacity-60">
			<div className="flex justify-center rounded-lg bg-clip-padding backdrop-filter backdrop-blur-lg px-8 pt-6 pb-8 mb-4 shadow-2xl text-base sm:text-2xl">
